import { UpdateDisputeMutation } from "@/queries/dispute"
...
const statuses = ["PENDING", "RESOLVED", "CANCELLED"]
...
export const UpdateDisputeModal = ({ id, trigger }: Props) => {
	const queryClient = useQueryClient()
	const [open, setOpen] = React.useState(false)

	const { isPending, mutate } = useMutation({
		mutationFn: (values: Payload) => UpdateDisputeMutation(id, values),
		mutationKey: ["update-dispute"],
		onSuccess: (data) => {
